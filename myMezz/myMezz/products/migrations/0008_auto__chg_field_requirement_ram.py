...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'products_requirement', 'ram', self.gf('django.db.models.fields.CharField')(max_length='4'))
    ...
    models = {
        ...
        u'products.requirement': {
            ...
            'ram': ('django.db.models.fields.CharField', [], {'default': "'2 GB'", 'max_length': "'4'"})
        }
    }
