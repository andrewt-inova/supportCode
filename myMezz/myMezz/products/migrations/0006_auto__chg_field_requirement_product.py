...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Requirement.product'
        db.alter_column(u'products_requirement', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['products.ProductSuite'], unique=True))

    def backwards(self, orm):

        # Changing field 'Requirement.product'
        db.alter_column(u'products_requirement', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['products.Product'], unique=True))
